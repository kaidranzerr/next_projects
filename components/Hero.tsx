  ...
  return (
    ...
    md:gap-28 lg:py-20 xl:flex-row'>
        ...
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
            We want to be on each of the journey seeking the satifaction of seeing the incorruptible beauty of nature.
        ...
        <div className="relative flex flex-1 items-start ">
                    <div className="relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8 ">
                        <div className="flex flex-col">
                            ...
                            <p className="bold-20 text-white">Aguas Caliantas</p>
                            </div>
                            ...
                            <div className="flexBetween">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="bold-20 text-white">573m</p>
                            </div>
                        </div>
                    </div>
        </div>
